export function Quote() {
  return (
    <section className="max-w-7xl mx-auto px-6 lg:px-12 pb-16 w-full">
      <div className="relative rounded-3xl bg-inverse-surface text-surface-container-lowest p-8 lg:p-14 overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-8 flex flex-col space-y-6">
            ...
            <div className="flex items-center gap-4 pt-2">
              <div className="w-12 h-12 rounded-full overflow-hidden shrink-0 ring-2 ring-primary/40">
                <img className="w-full h-full object-cover" data-alt="High-contrast black and white editorial portrait of a seasoned female cyber threat intelligence director in a minimalist modern operations center with subtle monitors in the background, sharp lighting, scholarly and authoritative." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCr4WOUX-wHwmZgElO1U8o3CMC8GbR6nyXQA3CkkrmQZty-mTWEfySp30qNoMpsN6nvd7Zq7LI6XD9qB-ewbaImTR6FD8wesGJfvxDVqptat5sR9csux17sPpAmjTBMcZkmAURkxIVcmI2jQt8vxR7v8ZE44OtxXXFB_prwCvSwB21fRIp4Lc8Gxl79PRwPyVh5-_DbP7Ni1tJfEylIjMGmcrRKZDh3jj_WJApVA2j0BSSWkLJM-dbj3g" alt="Dr. Aris Thorne" />
              </div>
              <div>
          ...
          <div className="lg:col-span-4 bg-white/5 backdrop-blur-md rounded-2xl p-6 flex flex-col space-y-4">
